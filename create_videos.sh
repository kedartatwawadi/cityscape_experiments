...
do
	...
	#cd 	pwd
        ...
        ffmpeg -r 17 -start_number $start_frame_num -i frankfurt_000000_%06d_leftImg8bit.png -vframes 30 -c:v libx265 -x265-params lossless  -pix_fmt yuv444p "$write_dir$crf"/frankfurt_000000_lossles_flag_$start_frame_num.mp4 
