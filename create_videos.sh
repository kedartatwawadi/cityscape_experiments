...
write_dir=~/Videos/leftImg8bit_sequence/frankfurt_videos/vp9_crf
max_frames=1499
...
do
    ...
    for crf in `seq 2 2 6`
    do  
        mkdir -p $write_dir$crf
        ffmpeg -r 17 -start_number $start_frame_num -i frankfurt_000000_%06d_leftImg8bit.png -vframes 30 -vcodec libvpx-vp9 -crf $crf -pix_fmt yuv444p $write_dir$crf/frankfurt_000000_$start_frame_num.webm    
