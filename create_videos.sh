...
do
    ...
    do  
        ...
        ffmpeg -r 17 -start_number $start_frame_num -i frankfurt_000000_%06d_leftImg8bit.png -vframes 30 -vcodec libx264 -crf $crf -pix_fmt yuv444p $write_dir$crf/frankfurt_000000_$start_frame_num.mp4   
